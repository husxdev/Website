	...
	return (
		...
		>
			<div className="flex flex-col items-center">
				...
				>
					<Card className="backdrop-blur-[1.5px] bg-black/5 mt-4 mx-auto py-5 w-[95%] min-w-[320px] max-w-md sm:max-w-xl md:max-w-2xl lg:max-w-3xl xl:max-w-4xl px-5 sm:px-7 border border-[#999a9e]/75 rounded-xl relative z-0 transition-all duration-300 ease-out hover:scale-[1.03] hover:shadow-[0_0_15px_rgba(35,32,32,20)] hover:border-opacity-70 hover:backdrop-blur-none">
						<video
						...
						<div className="relative z-10">
							<CardHeader className="flex flex-col sm:flex-row items-center gap-4">
								<motion.div
									...
									className="text-white text-sm flex-[1.5] bg-white/[0.02] backdrop-blur-sm px-4 py-2 rounded-xl shadow-lg border border-white/[0.03]"
								>
									In my teens, I gained an interest in
									programming which led me to chase a
									career in the area which I have a passion for and I'm always
									looking to learn more and to make a difference in the world.
								</motion.div>
								<motion.div
									initial={{ opacity: 0, y: 20 }}
								...
								<div className="flex-1 sm:ml-8 text-center sm:text-left">
									...
									>
										Focused on Discord Development and always exploring
										new resources to enhance and improve my skill set.
									</motion.div>
									<motion.div
										whileHover={{
											scale: 1.03,
