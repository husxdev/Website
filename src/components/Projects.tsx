...
const projects = [
	{
		name: "EquicordPlugins",
		description:
			"A list of plugins I've made for the Equicord Discord Client.",
		url: "https://github.com/husxdev/EquicordPlugins",
	...
	},
    {
        name: "Icies Hosting",
        description:
        "A hosting service for Minecraft Servers, Discord bots, and more.",
        url: "https://discord.gg/SDvKEUxgTp",
        icon: "https://cdn.discordapp.com/icons/1333790656136744961/e5167d3341aad1de8667ecb3c14d9688.webp?size=1024",
        language: "Java"
    },
    {
        name: "Eclipse",
        description:
        "A Discord Self-Bot that can do anything you want it to.",
        url: "https://github.com/husxdev/Eclipse-Self-Bot",
        icon: "https://cdn.discordapp.com/icons/1341877134330695721/4689fb9e26663ea59b09ff23be2bfdd2.webp?size=1024",
        language: "JavaScript"
    },
];
		...
		<div id="projects" ref={ref} className="mt-10 flex flex-col items-center">
			...
			>
				{projects.map((project, index) => (
					...
					>
						<Card className="bg-black/5 backdrop-blur-[1.5px] border border-[#999a9e]/75 rounded-xl relative z-0 transition-all duration-300 ease-out hover:shadow-[0_0_15px_rgba(35,32,32,20)] hover:border-opacity-70 hover:scale-[1.03] hover:backdrop-blur-none">
							<video
										...
										<div className="flex items-center gap-3">
											...
											{project.url.includes("github.com") &&
												stars[project.url] !== undefined && (
													<div className="border border-[#999a9e]/10 non-selectable flex items-center gap-1.5 text-sm text-gray-400 bg-zinc-900/50 px-3 py-1 rounded-full transition-all duration-300 ease-out hover:scale-105 hover:shadow-[0_0_4px_rgba(255,255,255,0.1)]">
														<svg
							...
							<CardBody className="px-4 py-1 pb-4">
								...
								{project.language && (
									<div className="border border-[#999a9e]/10 non-selectable flex items-center gap-1.5 text-xs text-gray-400 bg-zinc-900/50 px-2 py-0.5 rounded-full w-fit transition-transform duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] hover:scale-105 hover:shadow-[0_0_2px_rgba(255,255,255,0.08)]">
										<Icon
			...
			>
				<TextFade
					...
					duration={1}
					words="Not all projects are shown here..."
